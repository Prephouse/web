    ...
    <>
      <Box sx={{ padding: theme => theme.spacing(3) }}>
        ...
        <Alert variant="outlined" severity="info" sx={{ margin: theme => theme.spacing(1, 0) }}>
          An interview consists of an introduction from you and multiple questions asked by our system and to be
          answered by you.
        </Alert>
      </Box>
      <Box sx={{ padding: theme => theme.spacing(3) }}>
        ...
        <Alert variant="outlined" severity="info" sx={{ margin: theme => theme.spacing(1, 0) }}>
          You will be required to show your face throughout the ______ and use your voice to conduct the _____. You will
          receive the full set of feedback after the _____ has been completed.
        </Alert>
      </Box>
      <Box sx={{ padding: theme => theme.spacing(3) }}>
        <FormControl component="fieldset" required>
          ...
          <FormHelperText>
            Choose whether to record a new ______ on our website or upload an existing (pre-recorded) _______{' '}
          </FormHelperText>
          <RadioGroup row name="radio-buttons-group-medium">
        ...
        <Alert variant="outlined" severity="info" sx={{ margin: theme => theme.spacing(1, 0) }}>
          You will be required to use your webcam and microphone through your browser in order to record a new _______
          on our website. You will receive instructions on how to perform the recording before you start.
        </Alert>
      </Box>
      <Box sx={{ padding: theme => theme.spacing(3) }}>
        <FormControl component="fieldset" required>
        ...
        <Alert variant="outlined" severity="info" sx={{ margin: theme => theme.spacing(1, 0) }}>
          You will receive some, but not all, automated feedback from our system as you go. You can use that feedback to
          improve your skills along the way!
        </Alert>
      </Box>
      <FormButtons primaryText="Confirm settings" secondaryText="Contact us for help" secondaryColor="warning" />
    </>
  );
};
